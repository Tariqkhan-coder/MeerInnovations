...
const testimonials = [
  {
    quote: "Meer Innovations gave me real-world confidence as a frontend developer. It bridged the gap between theory and practical development",
  ...
  {
    quote: "Working with Meer Innovations gave me the confidence to build frontend projects that matter in the real world. The mentorship and teamwork made all the difference",
    ...
    <section className="w-full py-16">
      ...
      {[...Array(5)].map((_, i) => (
        ...
        />
                ...
                <img src="/assets/testimonials/Meer Innovations.jpeg" className="h-4 w-4" />
               <span className="text-shadow-xs text-gray-200">Verified Meer Innovations Intern</span>
               </div>
