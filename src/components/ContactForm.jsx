...
const ContactForm = () =>{
    ...
    return (
        <section className='py-12 px-4 md:px-20'>
            ...
            <h2 className="text-3xl font-bold text-white">Why Meer Innovations?</h2>
            </div>
            <p className="text-sm italic">"At Meer Innovations, we believe in building future-ready talent through real-world experiences."</p>
            <p className="text-sm italic">"Empowering developers to turn ideas into impact."</p>
           <p className="text-sm italic">"Innovation, Collaboration, Excellence — That’s Meer Innovations."</p>
            </div>
            {/* right side */}
            <div className='md:w-[70%] p-6 md:p-10 bg-[#002147]'>
            <h2 className='text-3xl font-bold mb-6 text-white-800'>Contact <span className="text-orange-500">Meer Innovations</span></h2>
