...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { name: "Journey", path: "/Meer Innovations-diaries", type: "scroll" },
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://www.instagram.com/Meer Innovations_/",
      name: "Instagram",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1 flex flex-col items-center text-center md:items-start md:text-left">
            <h3 className="text-2xl font-bold text-white mb-4">Meer Innovations</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-slate-300">
                ...
                <a
                  href="mailto:info@Meer Innovations.com"
                  className="hover:text-orange-400 transition-colors"
                >
                  infoMeer Innovations@gmail.com
                </a>
              </div>
              <div className="flex items-center text-slate-300">
        ...
        <div className="border-t border-slate-800 mt-12 pt-8">
          <div className="flex justify-center">
            <p className="text-slate-400 text-sm">
              © 2024 Meer Innovations. All rights reserved.
            </p>
          </div>
        </div>
      </div>
