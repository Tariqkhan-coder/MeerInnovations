...
const SingleProjectItem = ({ project }) => {
  return (
    <motion.div
      ...
      whileHover={{ y: -9 }}
      className="bg-slate-900 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-lg p-5 group sm:p-7 hover:shadow-2xl hover:shadow-orange-500"
    >
      {/* Project Thumbnail */}
