...
import InternesTestimonials from './DevSumDairiesPage/index';
  ...
  return (
    <>
      <div className="min-h-screen bg-[#002147]">
        {/* Hero Section */}
        <section className="min-h-screen flex items-center justify-center py-30 px-4 relative overflow-hidden">
