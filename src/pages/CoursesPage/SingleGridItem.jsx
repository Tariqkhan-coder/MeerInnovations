...
const SingleGridItem = ({ course }) => {
  return (
    <motion.div
      ...
      whileHover={{ y: -9 }}
      className="h-full flex flex-col rounded-lg overflow-hidden shadow-lg bg-slate-900 transition-all duration-300 p-5 group sm:p-7 hover:shadow-2xl hover:shadow-orange-500"
    >
      {/* Course Image */}
