...
export const internesData = [
  {
    ...
    description:
      "At Meer Innovations, I worked on modern web applications using cutting-edge technologies. Gained hands-on experience with full-stack development and cloud integration.",
    rating: 4.7,
  },
  {
    id: 2,
    ...
    description:
      "During my internship at Meer Innovations, I contributed to building responsive user interfaces and learned modern frontend architectures in a professional Agile environment.",
    rating: 4.5,
  },
  {
    id: 3,
    ...
    description:
      "At Meer Innovations, I developed scalable backend services and APIs. Gained valuable experience in database design and cloud infrastructure management.",
    rating: 4.2,
  },
  {
    id: 4,
    ...
    description:
      "My internship at Meer Innovations allowed me to work on data-intensive applications using Python frameworks. Learned best practices for building robust web services.",
    rating: 4.8,
  },
  {
    id: 5,
    ...
    description:
      "At Meer Innovations, I collaborated on designing intuitive user interfaces and creating engaging user experiences for various digital products.",
    rating: 4.6,
  },
];
